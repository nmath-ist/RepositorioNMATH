    ...
    <div className="welcome-box">
      ...
      <p  className="welcome-box-text"> O repositório permite os utilizadores fazerem upload de documentos. Para isso, deves verificar: </p>
        <ol>
            ...
            <li> Se o documento for um teste ou exame deves colocar o seu nome nos seguintes formatos: [Iniciais da Cadeira]_[Tipo de Avaliação]_[Rec - Apenas se for recurso]_[Ano Letivo][R]. 
              O símbolo [R] apenas se usa se o teste/exame tiver resolução.
              Exemplo: AL_Map1_2223[R] </li>
